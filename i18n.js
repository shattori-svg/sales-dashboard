(function () {
  ...
  var messages = {
    ja: {
      ...
      daily_section_title: '日別集計（週間トレンド・部門構成）',
      daily_hint: '日別の売上トレンドと部門構成を表示します。',
      week_ending: '週の終了日',
    ...
    en: {
      ...
      daily_section_title: 'Daily aggregation (weekly trend and composition)',
      daily_hint: 'View weekly sales trend and department composition by day.',
      week_ending: 'Week ending (End date)',
      daily_empty: 'Select an end date to load the daily summary.',
    ...
    th: {
      ...
      daily_section_title: 'สรุปรายวัน (แนวโน้มรายสัปดาห์และสัดส่วนแผนก)',
      daily_hint: 'ดูแนวโน้มยอดขายรายสัปดาห์และสัดส่วนแผนกตามวัน',
      week_ending: 'สิ้นสุดสัปดาห์ (วันที่)',
      daily_empty: 'เลือกวันที่สิ้นสุดเพื่อโหลดสรุปรายวัน',
